...
- (id)initWithArtist:(Artist*)artist
{
    ...
    if (self) {
        ...
        artistImagePlaceholderContainer.layer.borderColor =
                [UIColor colorWithRed:100.0/255.0
                                green:100.0/255.0
                                 blue:100.0/255.0
                                alpha:0.1].CGColor;
        ...
        UIView *artistBiographyContainer = [[UIView alloc]
                 initWithFrame:CGRectMake(kPadding,
        ...
        [[UIView alloc]
         initWithFrame:CGRectMake(artistImagePlaceholderContainer.right -
                                    artistName.width -
                                    (kPaddingSmall * 2) -
                                    1,
                                  artistImagePlaceholderContainer.bottom -
                                    artistName.height -
                                    (kPaddingSmall * 2) -
                                    1,
                                  artistName.width +
        ...
        self.frame = CGRectMake(0, 0,
                                ...
                                [Artisan calculateLabelHeightWithText:artist.biography
                                                        ...
                                                        thatFitsWidth:320.0 - (kPadding * 4)] + (kPadding * 5) :
                                artistImageHeight + (kPadding * 2));
    }
    return self;
}
// and here
+ (CGFloat) cellHeightForArtist:(Artist*)artist
{
    ...
    return ([artist.biography length] > 0) ?
    artistImageHeight +
    [Artisan calculateLabelHeightWithText:artist.biography
                                  andFont:[Artisan defaultBodyFont]
                            thatFitsWidth:320.0 - (kPadding * 4)] + (kPadding * 5) :
