...
- (void)playMix
{
    ...
    UINavigationController *navigationController =
        [[UINavigationController alloc] initWithRootViewController:mixPlayerViewController];
    HomeViewController *homeViewController =
        [AppDelegate sharedAppDelegate].viewController;
    [homeViewController presentViewController:navigationController
                                     animated:YES
                                   completion:nil];
